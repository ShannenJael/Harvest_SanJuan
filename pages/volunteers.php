<?php
/**
 * Harvest Baptist Church San Juan - Visitation Volunteers List (Password Protected)
 */
...
if (isset($_POST['username']) && isset($_POST['password'])) {
    if ($_POST['username'] === $ADMIN_USERNAME && $_POST['password'] === $ADMIN_PASSWORD) {
        $_SESSION['volunteers_authenticated'] = true;
...
if (!isset($_SESSION['volunteers_authenticated']) || $_SESSION['volunteers_authenticated'] !== true) {
    ?>
    <!DOCTYPE html>
    <html lang="en">
    <head>
        ...
        <title>Volunteers Login - Harvest Baptist Church San Juan</title>
...
<head>
    <meta charset="UTF-8">
    <meta name="viewport" content="width=device-width, initial-scale=1.0">
    <title>Visitation Volunteers - Harvest Baptist Church San Juan</title>
    <link rel="stylesheet" href="https://cdnjs.cloudflare.com/ajax/libs/font-awesome/6.0.0/css/all.min.css">
...
<body>
    <div class="container">
        <div class="header">
            ...
            <div class="header-actions">
                <a href="visitation.html" class="logout-btn">
                    ...
                    <?php else: ?>
                        ...
                        ?>
                            <tr>
                                ...
                                <td><?php echo date('M j, Y g:i A', strtotime($volunteer['submittedDate'])); ?></td>
                            </tr>
                        <?php endforeach; ?>
                    <?php endif; ?>
                </tbody>
    ...
    <script>
        ...
        function exportPDF() {
            ...
            doc.setFontSize(14);
            doc.text('Visitation Volunteers - New Movers', 14, 28);
            doc.setFontSize(10);
            ...
            // Save
            doc.save(`visitation-volunteers-${new Date().toISOString().split('T')[0]}.pdf`);
        }
    </script>
</body>
</html>
